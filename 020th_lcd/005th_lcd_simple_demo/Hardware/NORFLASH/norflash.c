...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void S3C2440_NorFlash_ChipWrite_HalfWord(unsigned int base, unsigned int offset, unsigned short val)
{
...
/**********************************************************************************************************
 ...
 @Return				val										: 读取值
**********************************************************************************************************/
unsigned short S3C2440_NorFlash_ChipRead_HalfWord(unsigned int base, unsigned int offset)
{
	/* -offset << 1 : Nor Flash 地址0位对应 S3C2440 地址1位, 所以 S3C2440 偏移地址左移1位- */
	volatile unsigned short* pNorFlashAddr = (volatile unsigned short*)(base + (offset << 1));
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void S3C2440_NorFlash_Write_Command(unsigned int offset, unsigned short cmd)
{
...
/**********************************************************************************************************
 ...
 @Return				val										: 数据值
**********************************************************************************************************/
unsigned short S3C2440_NorFlash_Read_Data(unsigned int offset)
{
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void S3C2440_NorFlash_Wait_Ready(unsigned int addr)
{
	unsigned int val;
	unsigned int pre;
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void S3C2440_NorFlash_Erase(unsigned int addr)
{
	/* -解锁- */
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void S3C2440_NorFlash_Read(unsigned int addr, unsigned char* buf, unsigned int len)
{
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void S3C2440_NorFlash_Write(unsigned int addr, unsigned char* buf, unsigned int len)
{
