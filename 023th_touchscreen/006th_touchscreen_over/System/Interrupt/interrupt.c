...
S3C2440_IRQ_Function			S3C2440_IRQ_Func_Array[IRQ_NUM];				//32个中断源执行函数数组
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_IRQRegister(unsigned char irqChannel, S3C2440_IRQ_Function fd)
{
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_IRQHandler(void)
{
	/* 分辨中断源 */
