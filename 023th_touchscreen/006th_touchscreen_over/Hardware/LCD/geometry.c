...
/**********************************************************************************************************
 @Function			void LCD_Geometry_Draw_Cross(int x, int y, int r, unsigned int color)
 @Description			LCD_Geometry_Draw_Cross	: 画十字
 @Input				x					: 坐标x
					y					: 坐标y
					r					: 半径
					color				: 颜色 32bit 0x00RRGGBB
 @Return				void
**********************************************************************************************************/
void LCD_Geometry_Draw_Cross(int x, int y, int r, unsigned int color)
{
	LCD_Geometry_Draw_Line(x-r, y, x+r, y, color);
	LCD_Geometry_Draw_Line(x, y-r, x, y+r, color);
}
