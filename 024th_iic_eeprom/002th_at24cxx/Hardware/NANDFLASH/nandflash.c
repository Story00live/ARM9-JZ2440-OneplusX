...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlashInitialized(void)
{
	/* -设置NAND FLASH时序- */
	NFCONF = (0<<12) | (1<<8) | (0<<4);
	...
	/* -复位Nand Flash- */
	S3C2440_NandFlashReset();
}

/**********************************************************************************************************
 @Function			void S3C2440_NandFlashReset(void)
 @Description			S3C2440_NandFlashReset
 @Input				void
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlashReset(void)
{
	/* -使能Nand Flash片选- */
	S3C2440_NandFlashSelect();
	/* -发送Reset命令- */
	S3C2440_NandFlash_Write_Command(0xFF);
	/* -等待就绪- */
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlashSelect(void)
{
	NFCONT &= ~(1<<1);
}
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlashDeselect(void)
{
	NFCONT |=  (1<<1);
}
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Write_Command(unsigned char cmmd)
{
	NFCMMD = cmmd;
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Write_Address(unsigned char addr)
{
	NFADDR = addr;
	for (volatile int i = 0; i < 10; i++);
}
...
/**********************************************************************************************************
 ...
 @Return				val										: 数据值
**********************************************************************************************************/
unsigned char __init S3C2440_NandFlash_Read_Data(void)
{
	return NFDATA;
}
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Write_Data(unsigned char val)
{
	NFDATA = val;
}
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Wait_Ready(void)
{
	while (!(NFSTAT & 1));
}
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Write_Data_Col_Address(unsigned int col)
{
	/* -发出Column Address- */
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Write_Data_Row_Address(unsigned int row)
{
	/* -发出Row Address- */
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Write_Data_Address(unsigned int addr)
{
...
/**********************************************************************************************************
 ...
 @Return				BadBlock									: 1 坏块
															  0 好块 
**********************************************************************************************************/
int __init S3C2440_NandFlash_Check_BadBlock(unsigned int addr)
{
	unsigned int nandFlashRow = addr / 2048;
...
/**********************************************************************************************************
 ...
 @Return				0										: True
					-1										: Error
**********************************************************************************************************/
int __init S3C2440_NandFlash_Erase(unsigned int addr, unsigned int len)
{
	unsigned int nandFlashRow = addr / 2048;
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Read(unsigned int addr, unsigned char* buf, unsigned int len)
{
...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void __init S3C2440_NandFlash_Write(unsigned int addr, unsigned char* buf, unsigned int len)
{
